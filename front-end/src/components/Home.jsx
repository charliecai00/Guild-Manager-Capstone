...
<body class="body-2">
    <section class="features-table wf-section">
        <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
            ...
            <div class="container-5 w-container"><a href="#" class="brand w-nav-brand">
    ...
    <div class="container-6 w-container">
        <div class="w-layout-grid grid-4">
            <div id="w-node-c920977c-e895-676e-2b6b-0e3c1d08f11c-f94199d8" data-current="Tab 3" data-easing="ease"
                data-duration-in="300" data-duration-out="100" class="tabs w-tabs">
                <div class="w-tab-menu"><a data-w-tab="Tab 1" class="tab-link-tab-1 w-inline-block w-tab-link">
                        <div>Party1</div>
                    </a><a data-w-tab="Tab 2" class="tab-link-tab-2-2 w-inline-block w-tab-link">
                        <div>Party2</div>
                    </a><a data-w-tab="Tab 3" class="tab-link-tab-3 w-inline-block w-tab-link w--current">
                        <div>Party3</div>
                    </a></div>
                <div class="w-tab-content">
                    <div data-w-tab="Tab 1" class="partytab w-tab-pane">
                        <div class="w-layout-grid grid-3">
                            <p id="w-node-e040523d-c925-c91d-da58-604e1c320bdd-f94199d8" class="paragraph">Hero
                                descriptions: including health, skills, and belongings.</p>
                            <div data-hover="false" data-delay="0"
                                id="w-node-af4b68af-720e-881d-70f7-723b642e25fa-f94199d8" class="w-dropdown">
                                <div class="dropdown-toggle-2 w-dropdown-toggle">
                                    <div class="icon-3 w-icon-dropdown-toggle"></div>
                                    <div class="text-block-4">HeroName</div>
                                </div>
                                ...
                                class="button-2 w-button">RECOVER</a><a
                                id="w-node-_99c3ae5e-abda-6ea8-ba06-0d560d2455c8-f94199d8" href="#"
                                class="button-3 w-button">FIRE</a>
                        </div>
                    </div>
                    <div data-w-tab="Tab 2" class="w-tab-pane">
                        <div class="w-layout-grid grid-3">
                            <p id="w-node-_6ee33b5c-3c48-71ee-deb9-f518a35ec9be-f94199d8" class="paragraph">Hero
                                descriptions: including health, skills, and belongings.</p>
                            <div data-hover="false" data-delay="0"
                                id="w-node-_6ee33b5c-3c48-71ee-deb9-f518a35ec9c0-f94199d8" class="w-dropdown">
                                <div class="dropdown-toggle-2 w-dropdown-toggle">
                                    <div class="icon-3 w-icon-dropdown-toggle"></div>
                                    <div class="text-block-4">HeroName</div>
                                </div>
                    ...
                    <div data-w-tab="Tab 3" class="w-tab-pane w--tab-active">
                        <div class="w-layout-grid grid-3">
                            <p id="w-node-f464c27a-6657-b7f0-cd55-02163752cc8e-f94199d8" class="paragraph">Hero
                                descriptions: including health, skills, and belongings.</p>
                            <div data-hover="false" data-delay="0"
                                id="w-node-f464c27a-6657-b7f0-cd55-02163752cc90-f94199d8" class="w-dropdown">
                                <div class="dropdown-toggle-2 w-dropdown-toggle">
                                    <div class="icon-3 w-icon-dropdown-toggle"></div>
                                    <div class="text-block-4">HeroName</div>
                                </div>
            ...
            <div id="w-node-_79f6d300-c96c-fd52-1da5-818921a8b43c-f94199d8" class="div-block">
                <div class="w-layout-grid grid-6"><img
                        ...
                        alt="" class="image-3" />
                    <div class="text-block">88888</div>
                </div>
            </div>
        </div>
    </div>
